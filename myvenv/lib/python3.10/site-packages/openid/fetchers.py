...
class Urllib2Fetcher(HTTPFetcher):
    ...
    def _makeResponse(self, urllib2_response):
        ...
        resp.headers = self._lowerCaseKeys(dict(list(urllib2_response.info().items())))
        ...
        _, extra_dict = self._parseHeaderValue(resp.headers.get("content-type", ""))
...
class CurlHTTPFetcher(HTTPFetcher):
    ...
    def _parseHeaders(self, header_file):
        ...
        for line in lines:
            try:
                ...
                raise HTTPError("Malformed HTTP header line in response: %r" % (line,))
    ...
    def fetch(self, url, body=None, headers=None):
        ...
        headers.setdefault("User-Agent", "%s %s" % (USER_AGENT, pycurl.version,))
